...
class AutoSchema(ViewInspector):
            ...
            if isinstance(parameter, OpenApiParameter):
                ...
                for property_name, property_schema in mapped["properties"].items():
                    try:
                        ...
                        field = None
                    result[property_name, OpenApiParameter.QUERY] = (
                        build_parameter_type(
                            name=property_name,
    ...
    def get_operation_id(self) -> str:
        ...
        if spectacular_settings.OPERATION_ID_METHOD_POSITION == "PRE":
            ...
            assert (
                False
            ), "Invalid value for OPERATION_ID_METHOD_POSITION. Allowed: PRE, POST"
    ...
    def _get_response_headers_for_code(
        self, status_code, direction="response"
    ) -> _SchemaType:
        result = {}
        for parameter in self.get_override_parameters():
    ...
    def get_serializer_name(
        self, serializer: serializers.Serializer, direction: Direction
    ) -> str:
        """override this for custom behaviour"""
